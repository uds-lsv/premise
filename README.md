...
## Code
You can either use our **pre-compiled versions in the `build` directory** or build Premise from code for your platform

- **For Linux (tested on Ubuntu 18.04, requires at least C++14):**  
  - Compile Premise by running `make` in the `code` directory.  

- **For macOS (Apple M silicon):**  
...
- **For Windows:**  
  - You can follow the [Windows Compilation Guide](Compiling_premise_in_Windows.pdf). If you check out the `windows` branch, you can skip the code modifications from the guide.
